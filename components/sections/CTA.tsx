...
export default function CTA() {
  ...
  const whatsappMessage = encodeURIComponent("Olá! Gostaria de saber mais sobre o catálogo digital para minha concessionária.");
  const whatsappLink = `https://wa.me/${whatsappNumber}?text=${whatsappMessage}`;

  return (
    <section id="contact" className="py-20 md:py-28 bg-gradient-to-b from-blue-50 to-white relative overflow-hidden dark:from-blue-950 dark:to-gray-900">
      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        ...
        >
          ...
          >
            ...
            <p className="text-sm text-blue-600/80 dark:text-blue-400/80">Concessionárias Satisfeitas</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-sm text-blue-600/80 dark:text-blue-400/80">Aumento em Visibilidade</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-sm text-blue-600/80 dark:text-blue-400/80">Veículos Catalogados</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-sm text-blue-600/80 dark:text-blue-400/80">Disponibilidade do Catálogo</p>
          </motion.div>
        </motion.div>
      </div>
    </section>
